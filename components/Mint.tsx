...
export default function Mint() {
  ...
  return (
    <>
      <h2 className="text-4xl mb-8" style={{display: "flex", justifyContent: "center", alignItems: "center",fontSize: "90px",marginBottom: "50px",fontFamily: "cursive",color: "white",WebkitTextStroke: "4px"}}>Minting</h2>

      <div className="border border-t-red-300 border-r-blue-300 border-b-green-300 border-l-yellow-300 rounded p-8" style={{background: "blueviolet",borderRadius: "30px"}}>
        <div className="flex justify-around border-b border-gray-700 pb-8">
          <div className="space-y-1">
            <div className="text-gray-400" style={{color: "black"}}>Supply:</div>
          ...
          <div className="space-y-1">
            <div className="text-gray-400" style={{color: "black"}}>Sale:</div>
            <div className="text-lg sm:text-2xl">
              {saleState === 0 && 'Closed'}
